...
// func compareNextRune(target rune, currentPos int, content []byte) bool {
// 	nextPos := currentPos + 1
// 	if nextPos >= len(content)-1 {
// 		return false
// 	}
//
// 	return rune(content[nextPos]) == target
// }

// func comparePrevRune(target rune, currentPos int, content []byte) bool {
// 	prevPos := currentPos - 1
// 	if prevPos < 0 {
// 		return false
// 	}
//
// 	return rune(content[prevPos]) == target
// }
